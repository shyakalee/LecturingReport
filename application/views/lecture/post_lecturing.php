			...
			<div class="row dash-section">
				...
				<div class="col-sm-9">
					<div class="thumbnail box-shadow">
						...
						<?php endif; ?>
						<form method="post" action="<?php echo base_url('Student/add/') ?>" role="form">
							...
							<div class="form-group">
								...
								<textarea rows="4" name="details" class="form-control" placeholder="Type here ..." required ></textarea>
							</div>
